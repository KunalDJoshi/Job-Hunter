...
public class HomePage extends JFrame implements ActionListener{
	...
	public HomePage() {
		...
		education.setBounds(879, 161, 150, 32);
		...
		discipline.setBounds(879, 229, 150, 32);
		...
		//reqSkills.addActionListener(new ActionListener() {
		//	public void actionPerformed(ActionEvent event) {
		//		Skills = reqSkills.getText().trim();
				//System.out.println(rSkills);
		//	}
		//});
		reqSkills.setBounds(879, 291, 457, 41);
		...
		experience.setBounds(879, 359, 150, 32);
